          ...
          child: Container(
              ...
              child:Column(
                  children:[
                    ...
                    SizedBox(height:30),
                    Text(title,
                        style:TextStyle(fontFamily:'RM',fontSize:22,color:Colors.red),textAlign: TextAlign.center,
                    ),
                    SizedBox(height:10),
                    Expanded(
          ...
          child: Container(
              ...
              child:Column(
                  children:[
                    ...
                    SizedBox(height:30),
                    Text(title,
                      style:TextStyle(fontFamily:'RM',fontSize:18,color:Colors.red),textAlign: TextAlign.center,
                    ),
                    SizedBox(height:10),
                    Text(des,
                      ...
                      text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(text: 'Features',
                                style: TextStyle(fontFamily:'RR',fontSize:19,color:Colors.red),
